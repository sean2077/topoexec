...
| TaskExecutor deterministic helper | `experimental` | Current task execution is deterministic, bounded, cooperatively cancellable before pending work starts, and reports post-return budget overruns. Threaded executor preview is future work. |
