...
| Scheduler thread-pool lane | `experimental` | Current behavior is bounded batch execution for ready invocations with non-reentrant serialization and queue admission metrics. Persistent worker lifecycle is future work. |
