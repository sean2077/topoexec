...
- [ ] Update `docs/61-api/public-api.md` when a header/type/function/class stability level changes.
- [ ] Update `docs/43-ci-build-release-tools/versioning.md` for schema, semantic-contract, release-target, or compatibility-policy changes.
- [ ] Update `CHANGELOG.md` for public behavior/API/docs changes.
- [ ] Update schema docs, JSON schema, and `docs/33-specs-rfcs/schema-v2-notes.md` classification if a schema field changes.
