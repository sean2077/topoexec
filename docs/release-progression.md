...
- Dependency-free Adapter SDK v0 plus G58/G59 dependency-free telemetry mapping
  previews and the G60 ROS 2 fake-boundary preview; no concrete ROS 2
  client-library package, production OpenTelemetry/Prometheus, Python, C
...
- Production ROS 2 packages, production OpenTelemetry/Prometheus, Python, Perfetto, C API, dynamic plugin
