#!/usr/bin/env python3
"""Check G84 beta readiness docs keep beta scope honest."""
...
def main() -> int:
    ...
    try:
        page = (root / "docs/43-ci-build-release-tools/core-runtime-beta-candidate-g84.md").read_text(encoding="utf-8")
        lowered = page.lower()
        for phrase in REQUIRED:
            require(phrase.lower() in lowered, f"G84 beta page missing {phrase}")
        ...
        require("core-runtime-beta-candidate-g84.md" in docs_readme, "docs map must link G84 page")
